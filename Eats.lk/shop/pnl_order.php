...
<style type="text/css">
        .body {
			...
			url('https://images.unsplash.com/photo-1549483532-d1945e6c48af?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80');
				...
				<table class="table">
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while ($row = mysqli_fetch_assoc($result)) {
							...
							for ($i = 0; $i < sizeof($order_list); $i++) {
								echo '<p class="font-italic">' . $ordr_stat[$i] . '</p>';
							}
							echo '</td>';
